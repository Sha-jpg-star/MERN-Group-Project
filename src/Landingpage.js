...
const LandingPage = () => {
  return (
    <>
      ...
      <Toolbar>
        <img src="/landingPageIcon2.png" alt="Logo" style={{height:"40px",marginRight:"12px"}}/>
        <Typography variant="h6" sx={{flexGrow:1,color:"black"}}>MediCare</Typography>
        <Button sx={{color:"white",backgroundColor:"navy"}} LinkComponent={Link} to="/Login">Log In</Button>
      </Toolbar>
      </AppBar>
