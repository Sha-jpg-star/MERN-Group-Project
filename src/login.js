...
const Login = () => {
    ...
    const handleDoctorLogin = () => {
        navigate("/DashboardDoctors"); // Redirect to Doctor Dashboard
    };
            ...
            <Container sx={{ display: "flex", marginBottom: "50px" }}>
                ...
                <Container maxWidth="xs" style={{ textAlign: "center", marginTop: "50px" }}>
                    ...
                    >
                        ...
                        <TextField label="Username / Email" variant="outlined" fullWidth margin="normal" />
                        ...
                        <Button variant="contained" fullWidth sx={{ marginTop: "15px", padding: "10px", color: "white", backgroundColor: "rgb(126, 124, 124)" }}>
                            LOG IN AS A GUEST
                        </Button>
                    </Box>
                </Container>
                ...
                <Container maxWidth="xs" style={{ textAlign: "center", marginTop: "50px" }}>
                    ...
                    >
                        ...
                        <Button
                            onClick={handleDoctorLogin} // Doctor login handler
                            fullWidth
                ...
                <Container maxWidth="xs" style={{ textAlign: "center", marginTop: "50px" }}>
                    ...
                    >
                        ...
                        <Button
                            onClick={handlePatientLogin} // Patient login handler
                            fullWidth
                            sx={{ marginTop: "15px", padding: "10px", color: "white", backgroundColor: "rgb(199, 4, 37)", boxShadow: "0px 4px 10px rgb(0, 22, 92)" }}
                        >
                            LOGIN
